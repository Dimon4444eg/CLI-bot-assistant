...
def help_user():
    print(
        "hello - Приветствие\n"
        "add_contact - Создать новый контакт\n"
        "delete_contact - Удалить существующий контакт\n"
        "add_phone - Добавить номер телефона к контакту\n"
        "edit_phone - Изменить существующий номер телефона у контакта\n"
        "search_phone - Удалить существующий номер телефона у контакта\n"
        "del_phone - Удалить существующий номер телефона у контакта\n"
        "add_email - Добавить електронную почту контакту\n"
        "edit_email - Изменить существующюю електронную почту у контакта\n"
        "del_email - Удалить существующюю електронную почту у контакта\n"
        "add_address - Добавить адресс контакта\n"
        "edit_address - Изменить существующий адресс у контакта\n"
        "del_address - Удалить существующий адресс у контакта\n"
        "add_note - Добавить заметку контакту\n"
        "del_note- Удалить заметку контакту\n"
        "contact_info - Информация о контакте"
        "all_contacts - Посмотреть все сохранённые контакты\n"
        "all_commands - Посмотреть все команды\n"
        "clean - Перебрать папку по форматам файлов\n"
        "load - Загрузить книгу контактов\n"
        "exit - Завершение работы ассистента\n"
    )
...
def main(file_pathz):
    path = Path(file_pathz)
    os.chdir(path)

    for der in extensions:
        try:
            os.mkdir(der)
...
extensions = {
    ...
    "images": ('.jpeg', '.png', '.jpg', '.svg', '.JPG'),
    "video": ('.avi', '.mp4', '.mov', '.mkv'),
    "documents": ('.doc', '.docx', '.txt', '.pdf', '.xlsx', '.pptx'),
    "audio": ('.vp3', '.ogg', '.wav', '.amr', '.mp3'),
    "archives": ('.zip', '.gz', '.tar'),
